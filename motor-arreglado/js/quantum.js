...
const QuantumEngine = {
  ...
  ejecutar(kFinal, shots = 1024) {
    ...
    // Valor exacto (cos^2(theta/2) * 100), sin ruido Monte Carlo: el circuito
    // es determinista y el numero principal debe ser reproducible.
    const estabilidadExacta = prob00 * 100;
    ...
    return {
      ...
      estabilidadExacta: Math.round(estabilidadExacta * 10000) / 10000,
    };
  },
