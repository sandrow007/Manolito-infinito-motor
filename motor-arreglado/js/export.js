...
const ExportEngine = {
  ...
  exportarCSV(resultado) {
    ...
    const filas = [
      ...
      ['espesor_m', resultado.thicknessM ?? ''],
    ...
    if (resultado.quantum) {
      filas.push(
        ...
        ['estabilidad_pct', resultado.quantum.estabilidadExacta ?? resultado.quantum.estabilidad],
      );
    }
  ...
  exportarPDF(resultado) {
    ...
    const quantumHTML = resultado.quantum ? `
      ...
      <table>
        ...
        <tr><td>Estabilidad |00&gt;</td><td>${(resultado.quantum.estabilidadExacta ?? resultado.quantum.estabilidad).toFixed(2)}%</td></tr>
        <tr><td>Nivel</td><td>${QuantumEngine.nivelEstabilidad(resultado.quantum.estabilidadExacta ?? resultado.quantum.estabilidad).texto}</td></tr>
    ...
    const html = `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8">
      ...
      <table>
        ...
        <tr><td>Espesor de la capa</td><td>${resultado.thicknessM ?? 0.1} m</td></tr>
      </table>
